...
export default function RegistrationSuccessPage() {
  ...
  const subText =
    'Thank you for registering for the first ever GG Pickleball league. Updates will be coming soon so keep an eye on your email. Be sure to add play@ggpickleball.co to your contact list to avoid updates going to your spam folder.';
  ...
  useEffect(() => {
    ...
    if (!(regionIdParam && seasonIdParam && teamIdParam)) {
