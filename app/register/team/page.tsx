...
export default function RegisterTeam() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      // Create team
      const teammate1Id = user._id
      const teamPayload = {
        teammates: [teammate1Id],
        captain: teammate1Id,
        regionId,
        seasonId,
        registrationStep: "REGISTERED_SELF",
        status: "REGISTERED",
      };
      ...
      router.push(`/register/team/teammate?seasonId=${seasonId}&regionId=${regionId}&teammate1=${user._id}&teamId=${team._id}`);
