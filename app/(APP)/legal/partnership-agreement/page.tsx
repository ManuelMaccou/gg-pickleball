        ...
        <Box style={{ maxWidth: 720 }}>
          ...
          <Section number="3" title="Promo Codes & Minimum Commitment">
            ...
            <SubSection title="3.3 Changes and Termination After Minimum Period">
              <Para>Following the Minimum Commitment Period, the Brand Partner may update, pause, or remove Promo Codes at any time, subject to providing thirty (30) days' prior written notice to GG Pickleball. This notice requirement does not apply to modifications that do not result in all Promo Codes being inactive (e.g., adjusting a discount amount or adding a new code).</Para>
            </SubSection>
            ...
            <SubSection title="3.5 Win Milestone Adjustments">
              <Para>GG Pickleball may update Win Milestone structures (including milestone increments) from time to time. GG Pickleball will provide Brand Partners with at least fourteen (14) days' prior written notice of any such changes. Brand Partners will have fourteen (14) days following notice to review and update their Promo Code configurations accordingly. Failure to update configurations within this period does not relieve the Brand Partner of their obligation to honor validly issued Promo Codes.</Para>
            </SubSection>
          </Section>
          ...
          <Section number="4" title="Commission & Billing">
            ...
            <SubSection title="4.3 Returns, Refunds, and Disputes">
              ...
              <BulletList items={[
                ...
                'If an Order remains in a held state on or after day 60 from the Order date, the record is flagged for manual review and automatic processing stops. GG Pickleball will contact the Brand Partner to resolve.',
              ]} />
            </SubSection>
          ...
          <Section number="6" title="Data & Privacy">
            ...
            <SubSection title="6.2 Player Data">
              <Para>GG Pickleball may share player email addresses with the Brand Partner solely where the applicable player has expressly opted in to sharing their contact information with brand partners on the Platform. Player data shared with the Brand Partner under this Agreement may only be used for communications directly related to the GG Pickleball partnership, such as order confirmations, promotional offers tied to the Platform, and partnership-related updates.</Para>
            </SubSection>
            <SubSection title="6.3 Prohibited Uses of Player Data">
              ...
              <BulletList items={[
                ...
                'Use player data for marketing, advertising, or communications unrelated to this partnership;',
