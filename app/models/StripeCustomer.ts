...
// via /admin/brand/billing/payment-method.
//
// Used in custom app mode only. In public app mode, billing is managed by
// Shopify App Pricing and this collection is not written to.
...
// Indexes are defined inline via unique: true on the schema fields above.
// No separate schema.index() calls needed — they would create duplicates.
